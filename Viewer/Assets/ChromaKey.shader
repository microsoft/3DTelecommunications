// https://github.com/otdavies/UnityChromakey/blob/04fa49c64c4d10d8e025250974da653bb46d9b17/Shaders/ChromaKey.shader
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 frag(v2f i) : SV_Target
                {
                    ...
                    //float delta = step(1.0, (1.0 - length(color.rgb - _KeyColor.rgb)) * 5.0);
                    //return float4(color.rgb, 1.0 - delta);
